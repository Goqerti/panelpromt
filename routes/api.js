...
// --- PARTNYORLAR ---
// Diqqət edin: sadəcə authMiddleware yox, authMiddleware.requireLogin yazılmalıdır
router.get('/partners', authMiddleware.requireLogin, partnerController.getAllPartners);
router.post('/partners', authMiddleware.requireLogin, partnerController.createPartner);
router.put('/partners/:id', authMiddleware.requireLogin, partnerController.updatePartner);
router.delete('/partners/:id', authMiddleware.requireLogin, partnerController.deletePartner);
